      ...
      <div className="w-full pt-16 md:pt-20">
        <div className="w-full max-w-6xl mx-auto px-3 md:px-6 pt-4 md:pt-6">
          ...
          <motion.div
            ...
            className="grid grid-cols-4 grid-rows-2 gap-1 md:gap-2 rounded-2xl md:rounded-3xl overflow-hidden"
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 text-white rounded-xl h-13 text-base font-semibold transition-all duration-300 active:scale-[0.97] py-3.5"
                  style={{
                    background: 'linear-gradient(135deg, #25D366 0%, #1da851 100%)',
                    boxShadow: '0 4px 20px -2px rgba(37, 211, 102, 0.35)',
                  }}
                >
