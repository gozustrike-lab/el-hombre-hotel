  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full mt-2 flex items-center justify-center gap-2 py-2.5 rounded-xl text-white text-sm font-semibold transition-all duration-300 hover:scale-[1.01] active:scale-[0.97]"
        style={{
          background: 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)',
          boxShadow: '0 3px 14px -2px rgba(37, 211, 102, 0.45)',
        }}
      >
        <WAIcon />
