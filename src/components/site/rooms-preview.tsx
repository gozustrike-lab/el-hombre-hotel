...
function RoomCard({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="relative group cursor-pointer rounded-2xl overflow-hidden bg-white dark:bg-slate-900 shadow-lg dark:shadow-black/20 hover:shadow-2xl hover:dark:shadow-black/40 transition-shadow duration-500"
    >
      {/* Image */}
...
export function RoomsPreview() {
  ...
  useEffect(() => {
    const close = () => setLightboxRoom(null);
