...
export function Services() {
  return (
    <section id="servicios" className="w-full py-24 md:py-32">
      {/* Section heading */}
      <div className="px-5 md:px-12 lg:px-20 mb-14">
        <motion.p
      ...
      {/* Services grid — full bleed on mobile, padded on desktop */}
      <motion.div
        ...
        className="w-full"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 md:gap-x-8 lg:gap-x-10">
