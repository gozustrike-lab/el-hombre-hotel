...
/* ─── Booking Bottom Sheet — Framer Motion ── */

export function BookingSheet() {
  const { bookingOpen, closeBooking } = useBookingContext();
        ...
        <>
          ...
          >
            ...
            >
              ...
              <button
                onClick={closeBooking}
                className="absolute right-4 top-3 w-9 h-9 rounded-full flex items-center justify-center transition-all active:scale-90 cursor-pointer"
                style={{
            ...
            <div className="px-6 pb-6 space-y-5">
                ...
                >
                  {[1, 2, 3, 4].map((n) => (
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 px-4 py-2.5 text-sm font-semibold transition-all duration-200 min-w-[44px] cursor-pointer"
                      style={{
              ...
              <button
                ...
                disabled={!canReserve}
                className="w-full flex items-center justify-center gap-2.5 rounded-xl text-base font-semibold transition-all duration-300 active:scale-[0.97] py-3.5 disabled:cursor-not-allowed cursor-pointer"
                style={{
